...
import {signup, mailVerified, login,logout, addStudentDetails, getStudent, forgetPassword, resetPassword } from "./student.controller.js";
...
router.route("/Verification/:id").post(authSTD, addStudentDetails)
